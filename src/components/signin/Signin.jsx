    ...
    return ( 
        ...
        <div className="sm:mx-24">
            ...
            <div style={{ backgroundImage: `url(${background})`}} 
                ...
                <button className="sm:w-42 sm:h-12 w-36 h-9 bg-none shadow sm:py-3 sm:px-7 py-1 px-2 bg-booking text-white hover:bg-bookingDark rounded-lg sm:text-sm text-xs transition200" onClick={setOpenModal}>ثبت نام در غربالگری</button>
                </div>
